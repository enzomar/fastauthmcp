"""Pydantic configuration models for the FastAuthMCP framework.

These models define and validate the structure of fastauthmcp.yaml configuration.
"""
...
class AuthConfig(BaseModel):
    ...
    upstream_token_header: str | None = Field(
        ...
        "to exchange. If set with grant_type=token_exchange, FastAuthMCP will "
...
class FastAuthMCPConfig(BaseModel):
    """Top-level FastAuthMCP configuration model.
