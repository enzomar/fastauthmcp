"""Built-in middleware placeholders for the FastAuthMCP framework.
...
class ObservabilityMiddleware:
    ...
    Delegates to the full implementation in fastauthmcp.middleware.observability.
    ...
    def __init__(self, config: Any) -> None:
        ...
        if self._enabled:
            from fastauthmcp.middleware.observability import (
...
class SessionMiddleware:
    ...
    Delegates to the full implementation in fastauthmcp.middleware.session.
...
class AuthenticationMiddleware:
    ...
    fastauthmcp.middleware.authentication for backward-compatible instantiation
