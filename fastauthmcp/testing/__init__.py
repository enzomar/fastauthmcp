"""FastAuthMCP testing utilities for simulating authenticated requests.

Provides FastAuthMCPTestClient for bypassing OAuth flows and injecting identity
...
class FastAuthMCPTestClient:
    ...
    def __init__(
        ...
        Args:
            app: The FastAuthMCP application instance to test against.
    ...
    async def call_tool(self, tool_name: str, **kwargs: Any) -> Any:
        ...
        # Set the identity context var so fastauthmcp.identity() works
        token = _identity_context_var.set(self._identity)
        # Set a test access token so fastauthmcp.access_token() works
        access_tok = _access_token_var.set("fastauthmcp-test-token")
...
class MockIdentityProvider:
    ...
    DEFAULT_SECRET = "fastauthmcp-test-secret"
    ...
    def __init__(self, secret: str | None = None) -> None:
        ...
        Args:
            secret: The HMAC secret key for signing JWTs.
                Defaults to "fastauthmcp-test-secret".
        """
